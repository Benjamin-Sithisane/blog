...
export default function PostCard({ post }) {
  return (
    ...
    dark:border-slate-500 hover:border-2 h-[400px] 
    ...
    >
      ...
      <div className='p-3 flex flex-col gap-2'>
        ...
        <span className='italic text-sm'>by: {post.author}</span>
        <Link
          to={`/post/${post.slug}`}
          className='z-10 group-hover:bottom-0 absolute bottom-[-200px] left-0 right-0 border 
          dark:border-slate-500 dark:text-slate-500 hover:bg-blue-900 dark:hover:text-white 
