...
export default function CreatePost() {
    ...
    return (
        <div className="p-3 max-w-3xl mx-auto mb-9 min-h-screen">
            <h1 className="mt-20 text-center text-3xl my-7 font-semibold">
                Create a Post
            </h1>
            <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                ...
                { imageUploadError && 
                    <Toast>
                        ...
                        <div className="ml-3 text-sm font-normal">{imageUploadError}</div>
                        <Toast.Toggle />
                    </Toast>
                }
